...
timber.productPage = function (options) {
    ...
    if (variant) {
        ...
        if (variant.available) {
            ...
            $AddToCartTextfree.html('FREE - JUST PAY SHIPPING');
        ...
        jQuery.each(cart, function(key, value) {
            if (key === 'items') {
                ...
                if (value.length) {
                    ...
                    $html += '<img src="//cdn.shopify.com/s/files/1/1291/3935/t/96/assets/checkout-button-icon.png?v=12234714965093864391" alt="" class="addIcon" />';
                    ...
                    $html +=  '</li><img alt="Checkout Secure" src="//cdn.shopify.com/s/files/1/1291/3935/t/96/assets/checkout_icon.png?v=17253768708377827341" class="no-border checkout-img ratina-img">';
...
timber.geoIP = function () {
    $(function(){
        ...
        $.getJSON("https://members.shoptimized.net/api/geo-ip/info.json", function(data){
            ...
            var supported_currencies = 'USD JPY CAD INR GBP EUR';
            ...
            if (!$.cookie('popupcookie')){
                setTimeout(function() {
                    if ($('#exit-popup').length) {
                        ...
                        $.cookie("popuppurcookie", 1, {expires: 2, path: '/'});
                        $.magnificPopup.open({
                            items: {
                                src: '#exit-popup'
                            },
        ...
        $.each($('.r_addtocartbutton button'), function(k, v) {
            ...
            $.each(product_ids_in_cart, function (x, y) {
                if ($(v).attr('onclick').indexOf(y) != -1) {
                    btn.attr('disabled', 'disabled' ).find('.r_AddToCartText').text('In cart').css('color', '#2980b9');
                }
            });
        });
    ...
    setTimeout(function () {
        ...
        $.getJSON('/cart.js', function (cart, textStatus) {
            ...
            if(showDecimals == 'no_decimals'){
              ...
              var shipping_value = '<span class="js-free-shipping-format">' + Currency.formatMoney(shipping, Currency.moneyFormats[Currency.shopCurrency][format || '{{amount}}']) + '</span>';
...
/// Live search
var preLoadLoadGif = $('<img src="//cdn.shopify.com/s/files/1/1291/3935/t/96/assets/ajax-load.gif?v=6293969950341419039" />');
...
$(document).on('keyup change', '.search_panel input[type="text"]', function(){
    ...
    if($(this).val().length > 2 && $(this).val() != $(this).data('oldval')) {
        ...
        //Show loading
        $resultsBox.html('<div class="load"><img src="//cdn.shopify.com/s/files/1/1291/3935/t/96/assets/ajax-load.gif?v=6293969950341419039"></div>');
...
$(document).ready(function(){
    ...
    var dealInterval = setInterval(function() {
        ...
        if(totalDeals > 0) {
            var date = new Date();
            var startdate = new Date('2021-06-24');
